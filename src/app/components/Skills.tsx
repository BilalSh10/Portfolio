...
const Skills = () => {
  return (
    ...
    > 
      <h1 className="font-bold text-7xl text-gray-900 p-8">Skills unlock doors!</h1>
      <div className="grid grid-cols-5 grid-rows-2 gap-x-7 gap-y-11 border border-gray-400 rounded-xl shadow-xl p-16">
