...
const Experience = () => {
  return (
    <div className="flex flex-col items-center pb-24">
      <h1 className="font-bold text-7xl text-gray-900 p-8">Experience</h1>
        <div className="flex flex-row gap-10">
            ...
            <div className="flex flex-col gap-10 items-center p-12">
                ...
                <h1 className="font-bold text-xl">
                    Sales agent, <span className="text-red-600">Golan Telecom.</span>
                </h1>
                ...
                <h1 className="font-bold text-xl">
                    ...
                    <span className="text-red-600"> Jerusalem municipality.</span>
                </h1>
                <p className="font-medium text-gray-600">
